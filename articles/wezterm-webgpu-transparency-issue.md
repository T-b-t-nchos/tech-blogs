...
![OpenGLとWezTermの比較](/images/wezterm-webgpu-transparency-issue/image1.png)
*手前がWebGPU、奥がOpenGL (透過後)*

`webgpu_power_preference`を`LowPower`にしてみると、何故か色がおかしくなる...(!?)

![色が変...](/images/wezterm-webgpu-transparency-issue/image2.png)
*暗い...*
